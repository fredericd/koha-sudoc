...
Pour ce faire, il est nécessaire de connaître le _jobid_ ABES de son
établissement : c'est l'identifiant ABES de la tâche automatisée qui extrait du
SUDOC les notices de l'établissement récemmment mises à jour. Cet identifiant
se trouve dans les messages envoyés par l'ABES. On lance alors la commande
suivante : `sudoc trans jobid`.
================================================================================
...
timeout::
  Délai en secondes entre deux réveils du service de transfert. Par
